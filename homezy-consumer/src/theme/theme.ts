// Homezy Design System — premium home-services brand
// Primary: teal-green; Accent: warm amber; Dark mode ready tokens included
...
export const colors = {
  ...
  primaryDark: '#008F6B',
  primaryLight: '#E0F7F2',
  primaryGradientStart: '#00C896',
  primaryGradientEnd: '#0091A3',
  ...
  shimmer: '#E8ECF2',
  shimmerHighlight: '#F6F8FC',

  // Category gradient pairs (for tile backgrounds)
  cat1: ['#FF6B6B', '#FF8E8E'],
  cat2: ['#4ECDC4', '#6EE7E0'],
  cat3: ['#45B7D1', '#74CDE0'],
  cat4: ['#96CEB4', '#B5DEC9'],
